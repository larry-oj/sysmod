...
/**
     ...
     */
public static PetriNet CreateNetFirstObject(
    double moveDelayMean,
    double carryDelayMean) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        ArrayList<PetriP> d_P = new ArrayList<>();
        ArrayList<PetriT> d_T = new ArrayList<>();
        ArrayList<ArcIn> d_In = new ArrayList<>();
        ArrayList<ArcOut> d_Out = new ArrayList<>();

        d_P.add(new PetriP("Пункт прибуття",0));
        d_P.add(new PetriP("P2",0));
        d_P.add(new PetriP("P3",0));
        d_P.add(new PetriP("P4",0));
        d_P.add(new PetriP("Робот вільний",1));

        d_T.add(new PetriT("Захоплення",moveDelayMean));
        d_T.add(new PetriT("Переміщення",0.0));
        d_T.add(new PetriT("Вивільнення",carryDelayMean));
        ...
        PetriNet d_Net = new PetriNet("FirstObject",d_P,d_T,d_In,d_Out);
...
public static PetriNet CreateNetSecondObject(
    int numChannels,
    String delayDistribution,
    double delayMean) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        ArrayList<PetriP> d_P = new ArrayList<>();
        ArrayList<PetriT> d_T = new ArrayList<>();
        ArrayList<ArcIn> d_In = new ArrayList<>();
        ArrayList<ArcOut> d_Out = new ArrayList<>();

        d_P.add(new PetriP("Черга верстат N-1",0));
        d_P.add(new PetriP("Черга робот N",0));
        d_P.add(new PetriP("Вільні слоти",numChannels));

        d_T.add(new PetriT("Обробка",delayMean));
        ...
        PetriNet d_Net = new PetriNet("SecondObject",d_P,d_T,d_In,d_Out);
...
public static PetriNet CreateNetBus(
    int price,
    double arrivingDelayMean,
    double aDelayMean,
    double bDelayMean,
    double exitFromBusDelayMean,
    int queue,
    int personsInBus,
    int cityFirstAvailable,
    int citySecondAvailable,
    String delayDistribution) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
        ...
        d_P.add(new PetriP("Надходить пасажир",1));
        d_P.add(new PetriP("P1",0));
        d_P.add(new PetriP("Черга",0));
        d_P.add(new PetriP("Втрачено",0));
        d_P.add(new PetriP("Вільний мікровтобус А",cityFirstAvailable));
        d_P.add(new PetriP("Вільний мікровтобус В",cityFirstAvailable));
        d_P.add(new PetriP("Успішність автопідприємства",0));
        d_P.add(new PetriP("Вільний мікровтобус А",citySecondAvailable));
        d_P.add(new PetriP("Вільний мікровтобус В",citySecondAvailable));

        d_T.add(new PetriT("Надходження",arrivingDelayMean));
        d_T.get(0).setDistribution(delayDistribution, d_T.get(0).getTimeServ());
        d_T.get(0).setParamDeviation(0.0);
        d_T.add(new PetriT("Встати в чергу",0.0));
        d_T.add(new PetriT("Вибір іншого маршруту - 1",0.0));
        d_T.get(2).setPriority(1);
        d_T.add(new PetriT("Перевезення автобусом В",bDelayMean + exitFromBusDelayMean));
        d_T.get(3).setDistribution(delayDistribution, d_T.get(3).getTimeServ());
        d_T.get(3).setParamDeviation(0.0);
        d_T.add(new PetriT("Перевезення автобусом А",aDelayMean + exitFromBusDelayMean));
        d_T.get(4).setDistribution(delayDistribution, d_T.get(4).getTimeServ());
        d_T.get(4).setParamDeviation(0.0);
        d_T.get(4).setPriority(1);

        d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
        d_In.add(new ArcIn(d_P.get(1),d_T.get(1),1));
        d_In.add(new ArcIn(d_P.get(2),d_T.get(2),queue));
        d_In.get(2).setInf(true);
        d_In.add(new ArcIn(d_P.get(1),d_T.get(2),1));
        d_In.add(new ArcIn(d_P.get(2),d_T.get(4),personsInBus));
        d_In.add(new ArcIn(d_P.get(4),d_T.get(4),1));
        d_In.add(new ArcIn(d_P.get(5),d_T.get(3),1));
        d_In.add(new ArcIn(d_P.get(2),d_T.get(3),personsInBus));

        d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
        d_Out.add(new ArcOut(d_T.get(0),d_P.get(0),1));
        d_Out.add(new ArcOut(d_T.get(1),d_P.get(2),1));
        d_Out.add(new ArcOut(d_T.get(2),d_P.get(3),price));
        d_Out.add(new ArcOut(d_T.get(4),d_P.get(6),price*personsInBus));
        d_Out.add(new ArcOut(d_T.get(3),d_P.get(6),price*personsInBus));
